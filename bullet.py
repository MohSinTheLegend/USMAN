...
\033[1;92m---------------------BRAND---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mHATERX MAKES ME FAMOUS USMAN ALI ..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     USMAN ALI
\033[1;94mFACEBOOK
                     https://www.facebook.com/Usman.Creations.005/
\033[1;91mWHATSAPP
                     MASOM HU NOI BNA HUA 😒
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/Usman.Creations.005/')
    else:
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  START CLONING With USMAN'
    time.sleep(0.10)
    print '\x1b[1;92m[2] USMAN ALI FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] USMAN ALI FACEBOOK'
    time.sleep(0.10)
